...
import com.fuelware.app.fw_manager.adapters.OnlinePaymentAdapter;
...
public class OnlinePaymentListActivity  extends SuperActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("Online Payment Receipts");
    ...
    private void setupRecycler() {
        ...
        adapter = new OnlinePaymentAdapter(list, this);
    ...
    private void setEventListeners() {
        btnAdd.setOnClickListener(v -> startActivity(new Intent(this, AddOnlinePaymentActivity.class)
    ...
    private void getCashReceipts() {
        ...
        APIClient.getApiService().getReceiptsList(authkey, "online-payment").enqueue(new Callback<ResponseBody>() {
            @Override
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    if (response.isSuccessful()) {
                        ...
                        MLog.showToast(OnlinePaymentListActivity.this, jsonObject.getString("message"));
                        list.remove(index);
                        adapter.refresh();
                        dialog.dismiss();
                    } else {
